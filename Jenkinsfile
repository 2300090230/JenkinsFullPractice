    ...
    stages {
        ...
        stage('Deploy Frontend to Tomcat') {
            steps {
                ...
                xcopy /E /I /Y "%WORKSPACE%\\onlineartgallery\\dist\\*" "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\reactonlineart"
                '''
            }
        }
        ...
        stage('Deploy Backend to Tomcat') {
            steps {
                ...
                copy "%WORKSPACE%\\OnlineArt\\target\\*.war" "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\"
                '''
            }
        }
